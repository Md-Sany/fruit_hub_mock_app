...
class InputCardDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Wrap in Material to fix the "No Material widget found" error
    return Material(
      ...
      child: Stack(
        ...
        children: [
          ...
          Container(
            ...
            child: SingleChildScrollView( // Fixes the RenderFlex overflow error
              child: Column(
                ...
                children: [
                  ...
                  // The Orange Button Container from your image
                  SafeArea(
                    child: Container(
                      width: double.infinity,
                      height: 100.h,
                      decoration: BoxDecoration(
                        color: const Color(0xFFFFB067), // Matching the lighter orange in image
                        borderRadius: BorderRadius.circular(24.r),
                      ),
                      child: Center(
                        child: ElevatedButton(
                          onPressed: () {
                            BasketManager().clearBasket(); // Clear items
