...
class BasketListSheet extends StatelessWidget {
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: Obx(() => basketController.items.isEmpty
  ...
  Widget _buildBasketItem(BasketItem item, int index, BasketController basketController) {
    return Dismissible(
      key: Key(item.product.id),
      direction: DismissDirection.endToStart,
      onDismissed: (direction) {
        basketController.removeAt(index);
      },
